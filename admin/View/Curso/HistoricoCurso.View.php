        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="page-header">
                    <h1>Curso
                        <small>Histórico do Curso</small>
                    </h1>
                    <span class="pull-right" style="float: right; margin-right: 10px; margin-top: -30px;">
                        <?php
                        echo '<a href="' . PASTAADMIN . UrlAmigavel::$controller . '/ListarCurso"
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php
                        $nome = "Curso " . $curso->getCoUltimoValorCurso()->getDsTitulo();
                        $historicos = $curso->getCoValorCurso();
