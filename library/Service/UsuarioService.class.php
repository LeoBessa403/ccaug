...
class  UsuarioService extends AbstractService
{
    ...
    public function salvaUsuario($dados, $foto, $resgistrar = false)
    {
        ...
        if ($validador[SUCESSO]) {
            ...
            $pessoa[DT_NASCIMENTO] = !empty($dados[DT_NASCIMENTO]) ? Valida::DataDBDate($dados[DT_NASCIMENTO]) :
            Valida::DataAtualBanco();
            $pessoa[ST_SEXO] = !empty($dados[ST_SEXO][0]) ? $dados[ST_SEXO][0] : 'M';
