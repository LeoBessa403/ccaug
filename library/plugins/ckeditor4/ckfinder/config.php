...
$pastaRaiz = str_replace($caminho, '', $_SERVER['SCRIPT_FILENAME']);
include $pastaRaiz . 'library/Config.inc.php';
define('PASTA_RAIZ_CKFINDER', HOME . 'uploads/Imagens/');
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => PASTA_RAIZ_CKFINDER,
//  'root'         => PASTA_RAIZ_CKFINDER, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
